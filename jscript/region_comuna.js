...
for (const region in region_comuna.regiones) {
    const option = document.createElement('option');
    option.value = region_comuna.regiones[region].numero;
    option.textContent = region_comuna.regiones[region].nombre;
...
const selectComuna = document.getElementById('select-comuna');
    selectComuna.innerHTML = ''; // Limpiar las comunas anteriores

    const selectedRegion = document.getElementById('select-region');
...
// Agregar evento al select de región
